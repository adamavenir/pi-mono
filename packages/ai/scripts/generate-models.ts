...
async function generateModels() {
	...
	// Together.ai models (OpenAI-compatible inference for open-source models)
	// Source: https://docs.together.ai/docs/serverless-models + https://www.together.ai/pricing
	const TOGETHER_BASE_URL = "https://api.together.xyz/v1";
	const togetherModels: Model<"openai-completions">[] = [
		{
			...
			reasoning: true,
			input: ["text"],
			cost: { input: 0.50, output: 2.80, cacheRead: 0, cacheWrite: 0 },
			contextWindow: 262144,
			maxTokens: 16384,
		},
		{
		...
		},
		{
			...
			reasoning: true,
			input: ["text"],
			cost: { input: 1.20, output: 4.00, cacheRead: 0, cacheWrite: 0 },
			contextWindow: 262144,
			maxTokens: 16384,
		},
		{
			...
			reasoning: false,
			input: ["text"],
			cost: { input: 0.60, output: 1.70, cacheRead: 0, cacheWrite: 0 },
			contextWindow: 128000,
			maxTokens: 16384,
		},
		{
			...
			reasoning: true,
			input: ["text"],
			cost: { input: 3.00, output: 7.00, cacheRead: 0, cacheWrite: 0 },
		...
		},
		{
			...
			reasoning: true,
			input: ["text"],
			cost: { input: 0.65, output: 3.00, cacheRead: 0, cacheWrite: 0 },
			contextWindow: 262144,
			maxTokens: 16384,
		},
		{
			...
			reasoning: false,
			input: ["text"],
			cost: { input: 2.00, output: 2.00, cacheRead: 0, cacheWrite: 0 },
		...
		},
		{
			...
			reasoning: false,
			input: ["text"],
			cost: { input: 0.50, output: 1.20, cacheRead: 0, cacheWrite: 0 },
			contextWindow: 262144,
			maxTokens: 16384,
		},
		{
			...
			reasoning: false,
			input: ["text"],
			cost: { input: 0.15, output: 1.50, cacheRead: 0, cacheWrite: 0 },
			contextWindow: 262144,
			maxTokens: 16384,
		},
		{
		...
		},
		{
			...
			reasoning: false,
			input: ["text"],
			cost: { input: 0.45, output: 2.00, cacheRead: 0, cacheWrite: 0 },
		...
		},
		{
			...
			reasoning: false,
			input: ["text"],
			cost: { input: 0.20, output: 1.10, cacheRead: 0, cacheWrite: 0 },
			contextWindow: 131072,
			maxTokens: 16384,
		},
		{
		...
		},
		{
			...
			reasoning: false,
			input: ["text"],
			cost: { input: 0.05, output: 0.20, cacheRead: 0, cacheWrite: 0 },
			contextWindow: 128000,
			maxTokens: 16384,
		},
		{
